...
emit_job() {
  ...
  case "$CORES" in
    1) _plm_cfg="${PLM_CFG_BASE}_n1n4_cal${_size_suffix}.sh" ;;
    *) _plm_cfg="${PLM_CFG_BASE}_n${CORES}_cal${_size_suffix}.sh" ;;
  esac
...
# =====================================================================
  *)
    echo "[ERR] Unknown mode: $MODE (supported: main, comparison, sensitivity, counterfactual, tuning, cap_sensitivity)"
    exit 1 ;;
esac
